...
# onset_date and end_date. Used for onset analysis, where explicit dates are
...
event_cols <- c(
  "1"  = "#FF4E00", "4"  = "#F5D547", "7"  = "#B1693B",
  "8"  = "#878844", "10" = "#33673B", "11" = "#638475",
  "13" = "#026B79", "16" = "#7B506F", "18" = "#1F1A38",
  "22" = "#6AD5CB"
)
...
#### ----------------------------------------------------------------- ####
#### The site summary table (with per-dataset thresholds) is built      ####
#### separately in site_summary_table_long.R.                           ####
#### ----------------------------------------------------------------- ####
